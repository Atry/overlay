...
Totality is desirable because total programs never get stuck, never produce runtime errors due to nontermination, and their behavior at any finite depth is always well-defined.

\subsection{The Challenge}

Most programming languages are \textbf{nontotal}. For example:
\begin{itemize}
...
\begin{enumerate}
  ...
  \item \textbf{Same-level DAG check} prevents nontermination:
    \begin{itemize}
...
\begin{itemize}
  ...
  \item Same-level DAG check (prevents nonterminating cycles)
