...
This appendix defines a first-order fixpoint B\"ohm tree
semantics for the $\lambda$-calculus in A-normal form (ANF),
and its first-iteration approximation, which is the lazy
...
\begin{itemize}
  ...
  \item $\mathrm{is\_abstraction}(s)$: whether $s$ is
    a $\lambda$-abstraction (i.e.\ has a binder slot).
