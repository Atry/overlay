...
This section defines the semantics as an indexed
hylomorphism~\cite{meijer1991functional,loh2011generic},
a family of mutually recursive unfold--fold
pairs, over six set-comprehension equations on paths,
in the style of fixpoint
semantics~\cite{vanemden1976semantics} and inductive
definitions~\cite{aczel1977inductive}.
Each semantic function has its own coalgebra (one-level
exploration) and algebra (combination), and the indexed
hylomorphism ties them together.
...
The answer is a system of six mutually recursive functions
...
Qualified this resolution (the $\this$ function defined below)
uses this provenance to map a definition-site mixin back to
...
This completes the six mutually recursive functions.
...
coalgebra--algebra decomposition for each equation,
...
model~\cite{hinze2015conjugate}, the equations \emph{are}
...
semantic-function applications\linebreak
...
inheritance source at an application\linebreak
node~$p$ contributes
$(n,\; (\mathrm{argument}))$
