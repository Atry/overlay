...
\begin{itemize}
  ...
  \item The induced semantics is a first-order,%
    ...
    fully abstract, and computable semantics of the lazy
    $\lambda$-calculus, requiring no function spaces, no
    substitution, and no separate operational semantics.
