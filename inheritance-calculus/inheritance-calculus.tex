...
\begin{description}
  ...
  \item[Immunity to nonextensibility]
    ...
    Theorem~\ref{thm:cartesian-non-expressibility}) demonstrate
  ...
  \item[Function color blindness]
    ...
    \footnote{Function color~\cite{nystrom2015color} arises when
      ...
      Non-structured control flow, such as capturing and resuming
...
\begin{theorem}[Non-expressibility of inheritance]
