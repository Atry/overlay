...
The Selector and Rebuilder combinators (Section~\ref{sec:trie}) demonstrate this
flexibility: their callback slots (\texttt{on\_zero}, \texttt{on\_odd},
\texttt{on\_even}) can be filled externally (CPS interpretation) or
composed locally (direct interpretation).
